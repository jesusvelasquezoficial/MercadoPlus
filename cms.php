...
<html lang="es">
  <head>
    <!-- Titulo -->
    <title>Mercado Plus - CMS</title>
    <!-- Descripcion del sitio -->
    <meta name="description" content="Sistema administrador de contenido de Mercado Plus.">
  ...
  <body data-offset="0" style="position:relative;">
    ...
    <!-- Contenido
    ================================================== -->
    <div data-spy="scroll" data-target="#principal" class="main-content w-auto " id="cajaContenidoCMS">
          ...
          <div class="header">
            <div class="header-body">
              <div class="row align-items-center">
                <div class="col">
                  <!-- Pretitle -->
                  <h4 class="header-pretitle"> Visión general </h4>
                  <!-- Title -->
                  <h2 class="header-title"> Ajustes </h2>
                </div>
              </div> <!-- / .row -->
              <div class="row align-items-center">
                <div class="col">
              ...
              <form class="mb-4 " action="core/core.php" method="post" id="form-datos">
                ...
                <div class="row d-flex justify-content-center">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <!-- Label -->
                      <label class="mb-1"> Dolar DICOM </label>
                      <!-- Input -->
                      <div class="input-group input-group-merge mb-3">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <!-- Label -->
                      <label class="mb-1"> Euro DICOM </label>
                      <!-- Input -->
                      <div class="input-group input-group-merge mb-3">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      ...
                      <!-- Label -->
                      <label class="mb-1"> Valor Euro Dolar </label>
                      <!-- Input -->
                      <div class="input-group input-group-merge mb-3">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <!-- Label -->
                      <label class="mb-1"> Bitcoin (BTC) </label>
                      <div class="row">
                        <div class="col-4">
                  ...
                  <div class="col-12 col-md-4">
                    <div class="form-group">
                      <div class="d-none d-md-block" style="margin-bottom: .5rem !important;height:1.2rem;"></div>
                      <!-- Label -->
                      <label class="mb-1"> Valor Petro </label>
                      <!-- Input -->
                      <div class="input-group input-group-merge mb-3">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <!-- Label -->
                      <label class="mb-1"> Petroleo </label>
                      <div class="row">
                        <div class="col-4">
