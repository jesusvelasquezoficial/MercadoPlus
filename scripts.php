...
<script type="text/javascript">
  ...
  function mostrarDatosOTC(num){
    $.ajax({
      ...
      if (long != 0) {
        ...
        bodyTasasMercados +='<td class="pb-0 text-right text-white" style="font-size:1.9em;"><h1>'+ updown(response[1]["pctvpromediototal"],true) +'</h1></td>';
        bodyTasasMercados +='</tr>';
  ...
  function mostrarDatosOficiales(num){
    $.ajax({
      ...
      if (long != 0) {
        bodyTasasMercados += '<div class="col-12 col-lg-6"><div class="card"><div class="card-body"><div class="row"><div class="col-12 col-sm-6">';
        ...
        bodyTasasMercados +='</div><div class="col-12 col-sm-6 align-items-center justify-content-center"><div class="">';
